...
from .models import FAQ, FAQCategory, Review, Portfolio, PortfolioCategory, TeamMember, Client, Portfolio,Blog
...
def webservices(request):
    ...
    filtered_portfolio = Portfolio.objects.filter(category__name__in=desired_categories)
    context = {
        'teamMember': teamMember,
        'current_page': current_page,
        'review': review,
...
def UIUX(request):
    ...
    desired_categories = ['UI/UX & Graphic',]
